...
OUT_PATH = REPO / "exports/trends-and-topics-june/fo-list-audit.md"
EXPORT_JSON = REPO / "exports/trends-and-topics-june/fo-list-audit-raw.json"
LIST_ID = 2
APRIL_SEND_ISO = "2026-05-06T00:00:00Z"  # prior (May) brief sent 2026-05-06
...
def main():
    ...
    md.append("")
    md.append("Family-office users in 2N who are NOT on AC list 2. Likely the most important section — these members won't receive the June brief unless added.")
    md.append("")
    if missing_in_ac:
